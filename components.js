...
/* ========== i18n Translations (common) ========== */
    var defaultTranslations = {
        'en': {
            ...
            // Shared test-runner / client portal keys
            'AI Assistant': 'AI Assistant', 'Auto-Detect': 'Auto-Detect',
            'Capture': 'Capture', 'Certified': 'Certified', 'Clear': 'Clear',
            'Day 7': 'Day 7', 'Day 14': 'Day 14', 'Day 28': 'Day 28',
            'Device': 'Device', 'Engineer Name': 'Engineer Name', 'Factory lab': 'Factory lab',
            'Full accreditation': 'Full accreditation', 'GPS': 'GPS',
            'Generate Report': 'Generate Report', 'Lab Name': 'Lab Name', 'Live Data': 'Live Data',
            'Location': 'Location', 'No': 'No', 'Notes': 'Notes', 'On-site check': 'On-site check',
            'Plot': 'Plot', 'Quick': 'Quick', 'Report Settings': 'Report Settings',
            'ReportDesc': 'Select report format to export test results with full credentials.',
            'Sample Number': 'Sample Number', 'Sample Specifications': 'Sample Specifications',
            ...
            'Overview': 'Overview', 'Performance Chart': 'Performance Chart', 'Recent Activity': 'Recent Activity',
            'Equipment': 'Equipment', 'Equipment desc': 'Lab & field testing equipment specifications',
            'Lab Equipment': 'Lab Equipment',
            'Schedule': 'Schedule', 'Schedule desc': 'Test scheduling and milestones', 'Test Schedule': 'Test Schedule',
            'Team Management': 'Team Management', 'Team Members': 'Team Members',
            'Team Schedule': 'Team Schedule', 'Team desc': 'Project team and assignments',
            'No Specimens': 'No Specimens', 'No active specimens': "You don't have any active specimens in the lab.",
            'No Invitations': 'No Invitations', 'No pending invitations': "You don't have any pending team invitations.",
            'Contact': 'Contact',
            // French
        ...
        'ar': {
            'home': 'الرئيسية', 'about': 'عن الشركة', 'services': 'الخدمات', 'contact': 'اتصل بنا',
            'Enter Lab': 'ادخل المختبر', 'Guest': 'زائر', 'Sign Out': 'تسجيل خروج',
            'Fimto Soft': 'فيمتو سوفت',
            'Integrated Tech Solutions': 'حلول تقنية متكاملة',
            'Quick Links': 'روابط سريعة', 'Our Locations': 'فروعنا',
            'We provide comprehensive software solutions including advanced interactive ERP systems, maintenance and development of ready-mix concrete plants, web design and development, distinguished digital marketing, creation and development of security and surveillance systems, establishment and development of infrastructure networks, creation and development of AI applications, and establishment and development of smart home systems.': 'نقدم حلولاً برمجية شاملة تشمل أنظمة ERP تفاعلية متقدمة، صيانة وتطوير مصانع الخرسانة الجاهزة، تصميم وتطوير المواقع، التسويق الرقمي المتميز، إنشاء وتطوير أنظمة الأمن والمراقبة، إنشاء وتطوير شبكات البنية التحتية، إنشاء وتطوير تطبيقات الذكاء الاصطناعي، وإنشاء وتطوير أنظمة المنازل الذكية.',
            'AI Assistant': 'مساعد الذكاء الاصطناعي', 'Auto-Detect': 'كشف تلقائي',
            'Capture': 'التقاط', 'Certified': 'معتمد', 'Clear': 'مسح',
            'Day 7': 'اليوم 7', 'Day 14': 'اليوم 14', 'Day 28': 'اليوم 28',
            'Device': 'الجهاز', 'Engineer Name': 'اسم المهندس', 'Factory lab': 'مختبر المصنع',
            'Full accreditation': 'اعتماد كامل', 'GPS': 'GPS',
            'Generate Report': 'إنشاء التقرير', 'Lab Name': 'اسم المختبر', 'Live Data': 'بيانات مباشرة',
            'Location': 'الموقع', 'No': 'لا', 'Notes': 'ملاحظات', 'On-site check': 'فحص موقعي',
            'Plot': 'رسم', 'Quick': 'سريع', 'Report Settings': 'إعدادات التقرير',
            'ReportDesc': 'اختر صيغة التقرير لتصدير نتائج الاختبار مع الاعتماد الكامل.',
            'Sample Number': 'رقم العينة', 'Sample Specifications': 'مواصفات العينة',
            ...
            'Overview': 'نظرة عامة', 'Performance Chart': 'مخطط الأداء', 'Recent Activity': 'آخر الأنشطة',
            'Equipment': 'المعدات', 'Equipment desc': 'مواصفات معدات الاختبار المعملية والميدانية',
            'Lab Equipment': 'معدات المختبر',
            'Schedule': 'الجدول', 'Schedule desc': 'جدولة الاختبارات والمراحل', 'Test Schedule': 'جدول الاختبارات',
            'Team Management': 'إدارة الفريق', 'Team Members': 'أعضاء الفريق',
            'Team Schedule': 'جدول الفريق', 'Team desc': 'فريق المشروع والمهام',
            'No Specimens': 'لا توجد عينات', 'No active specimens': 'لا توجد عينات نشطة في المختبر.',
            'No Invitations': 'لا توجد دعوات', 'No pending invitations': 'لا توجد دعوات فريق معلقة.',
            'Contact': 'اتصل بنا',
        }
    };
...
<div class="m-overlay-global" id="g-modal-features">
  <div class="m-box-global wide">
    ...
    <div class="m-box-global-body"><div class="f-list-global">
      ...
      <div class="f-item-global"><h3 class="f-title-global" onclick="this.classList.toggle('open')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg><span>أجهزة SmartLab الذكية</span><svg class="f-arrow-global" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><polyline points="6 9 12 15 18 9"/></svg></h3><div class="f-body-global"><ul><li>ESP32 PZT EMI Monitor - مراقب الذبذبات داخل اختبار الضغط</li><li>Concrete Cube Tester - جهاز تكسير مكعبات الخرسانة (Arduino + HX711)</li><li>تعمل داخل صفحة اختبار الضغط من قائمة SmartLab المنسدلة</li><li>مسح EMI، تتبع الرنين، مؤشر التلف، المعايرة، التقارير والملفات</li><li>كل جهاز جديد يُضاف تلقائياً لقائمة SmartLab</li></ul></div></div>
