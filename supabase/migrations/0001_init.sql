...
--
-- NOTE: tables are created BEFORE the functions that reference them, so that
-- PostgreSQL's function-body check passes.
...
-- ============================================================
-- RLS POLICIES (all reference public.is_staff, defined above)
-- ============================================================
